defmodule ProjectsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ProjectsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ProjectsWeb.Gettext, "errors", msg, opts)
    end
  end
